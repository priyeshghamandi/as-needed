...
import { canViewFacilities } from "@/lib/auth/facilities-access-rules";
...
export async function loadFacilitiesPageContext(callbackPath = "/facilities") {
  ...
  if (!canViewFacilities(primaryRole)) redirect("/login");
