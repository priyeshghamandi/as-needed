...
import { canViewShifts } from "@/lib/auth/shifts-access-rules";

export async function loadShiftsPageContext(callbackPath = "/shifts") {
  ...
  if (!canViewShifts(primaryRole)) redirect("/login");
