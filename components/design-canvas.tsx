// @ts-nocheck — legacy design-canvas prototype; typed gradually if promoted to production UI.
"use client";
...
function DCViewport({ children, minScale = 0.1, maxScale = 8, style = {} }) {
  ...
  const tfKey =
    "dc-viewport:" + (typeof window !== "undefined" ? window.location.pathname : "ssr");
