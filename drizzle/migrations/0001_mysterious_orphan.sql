...
--> statement-breakpoint
ALTER TABLE "agencies" ADD COLUMN IF NOT EXISTS "service_area_radius_miles" integer DEFAULT 75 NOT NULL;
--> statement-breakpoint
ALTER TABLE "agencies" ADD COLUMN IF NOT EXISTS "operational_contact_name" varchar(120);
--> statement-breakpoint
ALTER TABLE "agencies" ADD COLUMN IF NOT EXISTS "operational_contact_email" varchar(255);
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "agencies" ADD COLUMN IF NOT EXISTS "staffing_specialties" jsonb DEFAULT '[]'::jsonb NOT NULL;
--> statement-breakpoint
ALTER TABLE "agencies" ADD COLUMN IF NOT EXISTS "onboarding_current_step" varchar(32) DEFAULT 'welcome' NOT NULL;
--> statement-breakpoint
ALTER TABLE "agencies" ADD COLUMN IF NOT EXISTS "onboarding_completed_at" timestamp with time zone;
--> statement-breakpoint
ALTER TABLE "agencies" ADD COLUMN IF NOT EXISTS "onboarding_progress" jsonb DEFAULT '{"completedSteps":[],"skippedSteps":[]}'::jsonb NOT NULL;
--> statement-breakpoint
DO $$ BEGIN
