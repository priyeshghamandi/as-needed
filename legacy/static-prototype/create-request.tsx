// Create Staffing Request — multi-step slide-over wizard
declare const React: any;
declare const window: any;

(() => {
const { useState, useMemo, useEffect } = React;
const { Icon, Dot, Avatar, Badge } = window;
...
// ───────────── Sheet ─────────────
function CreateRequestSheet({ open, onClose, onCreated }: any) {
...
window.CreateRequestSheet = CreateRequestSheet;
})();
