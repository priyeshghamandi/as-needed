// Page sections — built from primitives
declare const React: any;
declare const window: any;
(() => {
const { useState: useStateS, useEffect: useEffectS, useRef: useRefS } = React;
const { Icon, Button, Badge, Dot, Eyebrow, SectionLabel, Avatar, AvatarStack } = window;
const { HeroDashboard } = window;
    ...
    <header className="sticky top-0 z-40 backdrop-blur bg-paper/80 border-b border-ink-200/60">
      <div className="max-w-[1240px] mx-auto px-8 h-14 flex items-center gap-8">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <Button as="a" href="signup.html" size="sm" variant="primary">
        ...
        <div className="grid grid-cols-12 gap-8 mt-8">
          <div className="col-span-12 lg:col-span-7">
            ...
            <div className="mt-8 flex items-center gap-3">
              <Button as="a" href="signup.html" size="lg" variant="primary">
...
// ────────────────────────────────────────────────────────────────────────────
function MultiUser() {
  const [active, setActive] = useStateS<"agencies" | "professionals" | "facilities">("agencies");
  const tabs = [
        ...
        <div className="relative rounded-3xl bg-ink-950 text-paper overflow-hidden p-12 lg:p-16">
          ...
          <div className="relative grid grid-cols-12 gap-8 items-end">
            <div className="col-span-12 lg:col-span-8">
              ...
              <div className="mt-8 flex items-center gap-3">
                <Button as="a" href="signup.html" size="lg" variant="teal">Sign up now <Icon name="arrow-right" className="w-4 h-4" /></Button>
