// RN Shift Interaction Flow — 6 mobile screens
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="rounded-2xl bg-white border border-ink-200 p-4">
          ...
          <div className="mt-3 pt-3 border-t border-ink-100 flex items-center gap-3 text-[10px] font-mono">
            ...
            <div className="ml-auto text-ink-700 tabular-nums">{Object.values(grid).reduce((acc:any, d:any) => acc + (d.day ? 1 : 0) + (d.night ? 1 : 0), 0)} slots open</div>
          </div>
        </div>
...
Object.assign(window, { S1_Notifications, S2_Details, S3_AcceptDecline, S4_MyShifts, S5_Availability, S6_Cancellation });
})();
