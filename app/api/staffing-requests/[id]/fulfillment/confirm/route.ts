...
import { confirmAgencyFulfillment } from "@/lib/fulfillment/confirm-fulfillment";
...
export async function POST(request: Request, context: RouteContext) {
  try {
    ...
    const result = await confirmAgencyFulfillment({
      agencyId,
    ...
    console.error("POST .../fulfillment/confirm failed", error);
