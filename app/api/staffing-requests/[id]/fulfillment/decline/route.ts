...
import { declineAgencyFulfillment } from "@/lib/fulfillment/decline-fulfillment";
...
export async function POST(request: Request, context: RouteContext) {
  try {
    ...
    const result = await declineAgencyFulfillment({
      agencyId,
    ...
    return NextResponse.json({ fulfillmentStatus: result.fulfillmentStatus });
  } catch (error) {
    ...
    console.error("POST .../fulfillment/decline failed", error);
